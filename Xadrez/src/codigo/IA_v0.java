...
public class IA_v0 extends Jogador {
	...
	private void comerPeca(Tabuleiro tabuleiro, Jogada ultimaJogada, ArrayList<Prioridade> listaDeLances) {
	 ...
	 */
	private void preservarPecas(Tabuleiro tabuleiro, Jogada ultimaJogada, ArrayList<Prioridade> listaDeLances) {
		ArrayList<Integer> prioridadesDosLances = new ArrayList<Integer> ();
		Tabuleiro tabuleiroAuxiliar = tabuleiro.copiaTabuleiro();
		...
		for (Jogada jogadaAux : listaDeLances) {
			casaAux = jogadaAux.getCasaOrigem();
